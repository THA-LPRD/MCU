...
namespace MCU
{
    ...
    SPI* SPI::CreateHardwareSPI(int8_t mosi, int8_t miso, int8_t sck, int8_t cs) {
    ...
    ESP32SPI::ESP32SPI(int8_t mosi,
                       int8_t miso,
                       int8_t sck,
                       int8_t cs,
                       spi_bus_config_t buscfg,
                       spi_device_interface_config_t devcfg) : SPI(mosi, miso, sck, cs) {
